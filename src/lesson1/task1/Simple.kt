...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    ...
    var b = sec.toDouble()
    var c = deg.toDouble()
    var toDegrees = c + (a / 60) + (b / 3600)
    var toRadians = toDegrees * (PI / 180)
    return toRadians
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    ...
    var b = percent.toDouble()
    var firstYear= a + (a * (b / 100))
    var secondYear = firstYear + (firstYear * (b / 100))
    var thirdYear = secondYear + (secondYear * (b / 100))
    return thirdYear
}
...
fun numberRevert(number: Int): Int {
    ...
    var q = last.toString()+second.toString()+first.toString()
    return q.toInt()
